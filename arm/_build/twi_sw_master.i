...
#line 17 "..\\twi_sw_master.c"

 
#line 26 "..\\twi_sw_master.c"


#line 35 "..\\twi_sw_master.c"
...
static _Bool twi_master_issue_startcondition(void);
static _Bool twi_master_issue_stopcondition(void);
static _Bool twi_master_clock_byte(uint_fast8_t databyte);
static _Bool twi_master_clock_byte_in(uint8_t * databyte, _Bool ack);
static _Bool twi_master_wait_while_scl_low(void);

_Bool twi_master_init(void)
{
		
    
    do { ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[(25U)] = ((0x00UL) << (16UL)) |((0x06UL) << (8UL)) |((0x03UL) << (2UL)) |((0UL) << (1UL)) |((0UL) << (0UL)); } while (0);  
    do { ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[(24U)] = ((0x00UL) << (16UL)) |((0x06UL) << (8UL)) |((0x03UL) << (2UL)) |((0UL) << (1UL)) |((0UL) << (0UL)); } while (0);  

    
    do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (1UL << (24U)); } while(0);
    do { ((NRF_GPIO_Type *) 0x50000000UL)->DIRSET = (1UL << (24U)); } while(0);

    
    do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (1UL << (25U)); } while(0);
    do { ((NRF_GPIO_Type *) 0x50000000UL)->DIRSET = (1UL << (25U)); } while(0);
...
_Bool twi_master_transfer(uint8_t address, uint8_t * data, uint8_t data_length, _Bool issue_stop_condition)
{
    ...
    if (address & (0x01))
    {
        ...
        while (data_length-- && transfer_succeeded)
        {
            ...
            if (data_length == 0) 
            {
                transfer_succeeded &= twi_master_clock_byte_in(data, (_Bool)0);
            }
            else 
            {
                transfer_succeeded &= twi_master_clock_byte_in(data, (_Bool)1);
            }
            data++;
        }
    }
...
static _Bool twi_master_clear_bus(void)
{
    ...
    if (((((NRF_GPIO_Type *) 0x50000000UL)->IN >> (25U)) & 0x1UL) == 1 && ((((NRF_GPIO_Type *) 0x50000000UL)->IN >> (24U)) & 0x1UL) == 1)
    {
        bus_clear = 1;
    }
    else if (((((NRF_GPIO_Type *) 0x50000000UL)->IN >> (24U)) & 0x1UL) == 1)
    {
        bus_clear = 0;
        
        for (uint_fast8_t i = 18; i--;)
        {
            do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = (1UL << (24U)); } while(0);
            nrf_delay_us(4);
            do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (1UL << (24U)); } while(0);
            nrf_delay_us(4);

            if (((((NRF_GPIO_Type *) 0x50000000UL)->IN >> (25U)) & 0x1UL) == 1)
            {
                bus_clear = 1;
                break;
            }
...
#line 212 "..\\twi_sw_master.c"
    ...
    do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = (1UL << (25U)); } while(0);
    nrf_delay_us(4);
...
static _Bool twi_master_clock_byte(uint_fast8_t databyte)
{
    ...
    do { ((NRF_GPIO_Type *) 0x50000000UL)->DIRCLR = (1UL << (25U)); } while(0);
    ...
    transfer_succeeded &= !(((((NRF_GPIO_Type *) 0x50000000UL)->IN >> (25U)) & 0x1UL));
...
static _Bool twi_master_clock_byte_in(uint8_t *databyte, _Bool ack)
{
    ...
    for (uint_fast8_t i = 0x80; i != 0; i >>= 1)
    {
        ...
        if (((((NRF_GPIO_Type *) 0x50000000UL)->IN >> (25U)) & 0x1UL))
        {
            byte_read |= i;
        }
        else
...
static _Bool twi_master_wait_while_scl_low(void)
{
    ...
    while (((((NRF_GPIO_Type *) 0x50000000UL)->IN >> (24U)) & 0x1UL) == 0)
    {
        

#line 486 "..\\twi_sw_master.c"
    }
