...
#line 137 "..\\..\\..\\..\\..\\..\\Include\\s110\\ble_gap.h"
 



 
#line 149 "..\\..\\..\\..\\..\\..\\Include\\s110\\ble_gap.h"
...
#line 228 "..\\..\\..\\..\\..\\..\\Include\\s110\\ble_gap.h"
...
#line 248 "..\\..\\..\\..\\..\\..\\Include\\s110\\ble_gap.h"
...
#line 1 "..\\..\\..\\..\\..\\..\\Include\\app_common\\pstorage_platform.h"
...
#line 23 "..\\..\\..\\..\\..\\..\\Include\\app_common\\pstorage_platform.h"
...
typedef void (*ble_lbs_led_write_handler_t) (ble_lbs_t * p_lbs, uint8_t led_state); 
...
typedef struct ble_lbs_s
{
    ...
    ble_gatts_char_handles_t    button_char_handles; 
		...
		ble_gatts_char_handles_t 		user_input_write_char_handles;
...
uint32_t ble_send_image(ble_lbs_t * p_lbs, uint8_t *data, uint16_t length); 
...
#line 2 "..\\twi_MPL_115A2.h"
#line 3 "..\\twi_MPL_115A2.h"
...
extern volatile uint16_t JPEG_file_size; 
extern uint8_t *p;
...
void LSY201_TakePic(void);						
void LSY201_FileSize(void);						
void LSY201_ReadFile(uint16_t LSY201_ChunkBytes);	
void Get_Full_JPEG(uint16_t BytesPerChunk);		
void LSY201_StopPic(void);						
void LSY201_CompRat(void);						
void LSY201_Resolution(uint8_t LSY201_Res);		
void LSY201_PowerSave(uint8_t LSY201_PS);		
void LSY201_BaudRate(uint8_t LSY201_BR);		
void delay_ms(float volatile delay_in_ms);		
void LED_FLASHY_TIME(void);						
void Find_FFD8(void);
void Find_FFD9(void);
void Skip_ack(void);
_Bool Get_Chunk_JPEG(uint16_t BytesPerChunk, uint8_t arr[]);
...
static app_timer_id_t                   m_temp_timer_id;														 
_Bool  temp_init_succeeded = 1;
_Bool  temp_read_succeeded;
_Bool  RETURN_IN_CELCIUS = 0; 
int8_t temp_MSB; 
int8_t temp_LSB; 
float temperature;
 

uint8_t pre_def_temp_param;

 
const uint8_t NUM_OF_BYTES_PER_CHUNK  = 248;        
...
uint32_t err_code_watcher; 
uint8_t flag = 0; 
_Bool done_with_chunk = 0; 
uint8_t arr[248]; 
uint8_t array[20];
uint16_t byte;

static void temp_level_meas_timeout_handler(void * p_context)
{
	...
	while(!(done_with_chunk)){
	done_with_chunk = Get_Chunk_JPEG(NUM_OF_BYTES_PER_CHUNK, arr);
	}
	...
	byte = size; 
	ble_send_image(&m_lbs, &array[0],size); 

		done_with_chunk = 0;
		
		temperature = temp_meas_update(&temp_MSB, &temp_LSB, RETURN_IN_CELCIUS); 
		if(flag > 0){
		if(temperature > pre_def_temp_param){
			err_code = ble_send_temp(&m_lbs, temperature); 
			if(err_code == ((0x0) + 0))
			{
			nrf_gpio_pin_toggle(18);		
			}
			err_code_watcher = err_code;	 
		}
		}
}
...
static void timers_init(void)
{
   ...
   do { static uint32_t APP_TIMER_BUF[((((( (((3)) * 40) + ( 3 * (8 + (((4) + 1) + 1) * 24) ) )) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_timer_init((0), (3), (4) + 1, APP_TIMER_BUF, (1) ? app_timer_evt_schedule : 0); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 220, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0); 

   err_code = app_timer_create(&m_temp_timer_id, 
                               APP_TIMER_MODE_REPEATED, 
                               temp_level_meas_timeout_handler); 
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 225, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
...
static void gap_params_init(void)
{
    ...
    err_code = sd_ble_gap_device_name_set(&sec_mode,
                                          (const uint8_t *)"Senior Design",
                                          strlen("Senior Design"));
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 246, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 256, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void advertising_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 287, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void on_conn_params_evt(ble_conn_params_evt_t * p_evt)
{
    ...
    if(p_evt->evt_type == BLE_CONN_PARAMS_EVT_FAILED)
    {
        ...
        do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 355, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    }
}
...
{
    do { app_error_handler((nrf_error), 366, (uint8_t*) "..\\main.c"); } while (0);
}
...
static void conn_params_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 389, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void advertising_start(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 418, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    nrf_gpio_pin_set(18);
}
...
static void on_ble_evt(ble_evt_t * p_ble_evt)
{
    ...
    switch (p_ble_evt->header.evt_id)
    {
        case BLE_GAP_EVT_CONNECTED:
            ...
            do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 441, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
            break;
        ...
        case BLE_GAP_EVT_DISCONNECTED:
            ...
            do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 449, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
        ...
        case BLE_GAP_EVT_SEC_PARAMS_REQUEST:
            err_code = sd_ble_gap_sec_params_reply(m_conn_handle,
                                                   0x00,
                                                   &m_sec_params);
            do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 458, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
            break;

        case BLE_GATTS_EVT_SYS_ATTR_MISSING:
            err_code = sd_ble_gatts_sys_attr_set(m_conn_handle, 0, 0);
            do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 463, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
            break;
        ...
        case BLE_GAP_EVT_SEC_INFO_REQUEST:
            ...
            if (p_enc_info->div == p_ble_evt->evt.gap_evt.params.sec_info_request.div)
            {
                ...
                do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 475, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
            }
            else
            {
        ...
        case BLE_GAP_EVT_TIMEOUT:
            if (p_ble_evt->evt.gap_evt.params.timeout.src == 0x00)
            {
                ...
                nrf_gpio_cfg_sense_input(16,
                                         NRF_GPIO_PIN_PULLUP,
                                         NRF_GPIO_PIN_SENSE_LOW);
                
                
                err_code = sd_power_system_off();
                do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 497, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
            }
            break;
...
static void ble_stack_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 552, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 559, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    
    
    err_code = softdevice_sys_evt_handler_set(sys_evt_dispatch);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 563, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
{
    do { static uint32_t APP_SCHED_BUF[((((((((sizeof(app_timer_event_t))) + 8) * (((10)) + 1))) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_sched_init((sizeof(app_timer_event_t)), (10), APP_SCHED_BUF); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 571, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);
}
    ...
    switch (pin_no)
    {
        case 17:
            ...
            if (err_code != ((0x0) + 0) &&
                ...
                err_code != ((0x0) + 8))
            {
                do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 587, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
            }
            break;

        default:
            do { app_error_handler((pin_no), 592, (uint8_t*) "..\\main.c"); } while (0);
            break;
    }
}
...
{
    do { static uint32_t app_gpiote_buf[((((((1) * 20)) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_gpiote_init((1), app_gpiote_buf); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 601, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);
}
...
static void buttons_init(void)
{
    ...
    {
        {16, 0, NRF_GPIO_PIN_PULLUP, 0},
        {17, 0, NRF_GPIO_PIN_PULLUP, button_event_handler}
    };

    do { uint32_t ERR_CODE = app_button_init((buttons), (sizeof(buttons) / sizeof(buttons[0])), (((uint32_t)((((50) * (uint64_t)32768) + ((((0) + 1) * 1000) / 2)) / (((0) + 1) * 1000)))), (1) ? app_button_evt_schedule : 0); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 617, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);
}
...
static void application_timers_start(void)
{
    ...
    err_code = app_timer_start(m_temp_timer_id, ((uint32_t)((((1000) * (uint64_t)32768) + ((((0) + 1) * 1000) / 2)) / (((0) + 1) * 1000))), 0); 
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 627, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
...
static void power_manage(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 636, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
int main(void)
{
  ...
  twi_master_init();
	simple_uart_config(8,9, 10,13, 0);		
