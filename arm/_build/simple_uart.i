...
#line 15 "..\\..\\..\\..\\..\\..\\Source\\simple_uart\\simple_uart.c"
...
uint8_t simple_uart_get(void)
{
    ...
    return ((NRF_UART_Type *) 0x40002000UL)->RXD;
}
...
void simple_uart_put(uint8_t cr)
{
    ((NRF_UART_Type *) 0x40002000UL)->TXD = cr;
                        ...
                        _Bool    hwfc)
{
    ...
    nrf_gpio_cfg_input(rxd_pin_number, NRF_GPIO_PIN_PULLDOWN);								 
    ...
    ((NRF_UART_Type *) 0x40002000UL)->ENABLE        = ((0x04UL) << (0UL));
		...
		((NRF_UART_Type *) 0x40002000UL)->EVENTS_CTS = 1;
